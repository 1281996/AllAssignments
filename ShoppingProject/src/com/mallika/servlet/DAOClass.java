...
Connection connection=ConnectionFactory.getConnection();
	...
	public String getInsertDataCart(int productId, String productName, int price) {
		...
		String insertTableSQL = "INSERT INTO cart1"
				+ "(productid,productname,productprice) VALUES"
				+ "(?,?,?)";
...
Connection connection=ConnectionFactory.getConnection();
		...
		try{
			PreparedStatement ps=connection.prepareStatement("select productid from product1 where PRODUCTID=? ");
			System.out.println(productId);
